...
def main(satellite: str, year: int, month: str) -> None:
    if not(16 < year or year < 23):
        raise ValueError(f"Year invalid ({year}). Use a value between '17' (for 2017) and '22' (for 2022) as the data is only available in this range.")
